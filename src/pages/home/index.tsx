    ...
    return (
        <div className="h-screen bg-violet-800 w-screen flex items-center justify-center">
            <div>
                ...
                <p className="font-semibold text-white text-center tracking-[7px] text-sm md:text-lg">A INITIATIVE BY <span className="font-bold">SPRITEERA</span></p>
                <h1 className="text-8xl font-bold text-white tracking-wider text-center">WAIT!! <span className=" text-violet-400">SURVEY</span></h1>
